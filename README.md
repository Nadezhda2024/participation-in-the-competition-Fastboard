# ДАШБОРД БЬЮТИ-ТРЕВОГА: БОЛЕВЫЕ ТОЧКИ БИЗНЕСА (Fastboard)
...
Целевой пользователь — Менеджер по продажам, который:
- Ежедневно отвечает за выполнение плана
- Ищет причины провалов в регионах
